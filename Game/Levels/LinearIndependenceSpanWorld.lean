...
Introduction "Welcome to Linear Independence and Span World! This world introduces the ideas of linear independence/dependence and the span of a set of vectors. You will prove theorems, for example that any subset of a linearly independent set of vectors is still linearly independent."
